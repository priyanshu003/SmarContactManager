...
import com.scm.services.SecurityCustomDetailUserService;
...
public class SecurityConfig {
    ...
    @Autowired
    private SecurityCustomDetailUserService userDetailService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.authorizeHttpRequests(authorize -> {
            ...
            authorize.requestMatchers("/page/login", "/page/authenticate").permitAll();
        ...
        httpSecurity.formLogin(formLogin -> {
            ...
            formLogin.loginProcessingUrl("/page/authenticate");
